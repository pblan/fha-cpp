...
std::string ts() {
  ...
  static std::array<std::string, 5> thread_names = {"Main", "Paul", "Lisa",
                                                    "Hans", "Rosi"};
  ...
  std::stringstream s;
  s << std::fixed << std::setw(6) << std::setprecision(3)
    << (double)(std::chrono::duration_cast<std::chrono::milliseconds>(
                    std::chrono::system_clock::now() - tm_start)
                    .count()) /
           1000.0
    << " [" << name << "]";
  return s.str();
