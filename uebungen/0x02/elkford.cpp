...
// Definieren Sie eine Struktur 'polynom', die ein Feld der Größe 'dim' von
// Koeffizienten 'coeffs' enthält.
struct polynom {
  double coeffs[dim];
};
...
// Programmieren Sie eine globale Funktion 'eval', um ein Polynom 'p' an einer
// Stelle 'x' auszuwerten. Übergeben Sie das Polynom  ('call-by-ref') und die
// Stelle der Funktion.
double eval(polynom &p, const double &x) {
